...
CLASS z2ui5_cl_layo_sample_02 IMPLEMENTATION.
  ...
  METHOD on_event.
    ...
    CASE client->get( )-event.
      ...
      WHEN `PREVIEW_FILTER`.
        client->nav_app_call( z2ui5_cl_layo_var_pop_range=>factory( mt_filter ) ).
      WHEN 'BACK'.
  ...
  METHOD z2ui5_if_app~main.
    ...
    IF client->check_on_init( ).
      ...
      mt_filter = z2ui5_cl_layo_var_pop_range=>read_default(
*        EXPORTING
...
*          result      =
    ...
    IF client->check_on_navigated( ).
      TRY.
          DATA(lo_value_help) = CAST z2ui5_cl_layo_var_pop_range( client->get_app_prev( ) ).
