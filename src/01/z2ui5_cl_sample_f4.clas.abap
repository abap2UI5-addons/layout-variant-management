CLASS z2ui5_cl_sample_f4 DEFINITION
  PUBLIC
  CREATE PUBLIC.
...
CLASS z2ui5_cl_sample_f4 IMPLEMENTATION.
  ...
  METHOD call_f4.
    ...
    client->nav_app_call( z2ui5_cl_pop_display_f4_help=>factory( i_table = f4_table
                                                         i_fname = f4_field
                                                         i_value = mv_arbgb ) ).
  ...
  METHOD on_after_f4.
    ...
    TRY.
        DATA(app) = CAST z2ui5_cl_pop_display_f4_help( client->get_app( client->get( )-s_draft-id_prev_app ) ).
